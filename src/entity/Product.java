    ...
    public void inputData(Scanner scanner, Product[] products, int currentIndex) {
        ...
        while (isLoop) {
            ...
            if(Pattern.matches("^[A-Z]\\w{3}", this.productId)) {
                ...
                isExist = true;
                System.err.printf("The ProductID  must be 4 characters with first character capitalized!!\n");
            }
        ...
        while (isLoop) {
            ...
            if(this.productName.length() < 1) {
                System.err.printf("The ProductName must be at least 1 character!!\n");
            }else {
                break;
            }
        }
        ...
        while (isLoop) {
            ...
            if(status == 0){
                ...
                System.err.printf("The ProductStatus must be 0 or 1!!\n");
            }
        }
    }
