...
import implement.StoreManagement;
            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        ...
                        for (int i = 0; i < StoreManagement.orderCurIndex; i++) {
                            Order order = new Order();
                            order.inputData(scanner, "PN", ProductBusiness.products, ProductBusiness.proCurIndex, EmployeeBusiness.employees, empCurIndex);
                            orders[i] = order;
                        }
